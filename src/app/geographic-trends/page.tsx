...
export default function GeographicTrends() {
      ...
      <div className="bg-latte text-espresso flex h-screen flex-col font-serif">
        ...
        <main className="container mx-auto flex flex-1 flex-col px-4 py-4">
          <div className="mb-4 flex w-full items-center justify-between gap-4">
            <Skeleton>
              <h1 className="text-coffee text-left text-xl font-bold opacity-0 md:text-2xl lg:text-3xl">
  ...
  return (
    <div className="bg-latte text-espresso flex h-screen flex-col font-serif">
      ...
      <main className="container mx-auto flex flex-1 flex-col px-4 py-4">
        <div className="mb-4 flex w-full items-center justify-between gap-4">
          <h1 className="text-coffee text-left text-xl font-bold md:text-2xl lg:text-3xl">
            Geographic Exhibition Trends
          </h1>
